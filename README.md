...
python graphcontrol.py --dataset Cora_ML --epochs 100 --lr 0.5 --optimizer adamw --weight_decay 5e-4 --threshold 0.17 --walk_steps 256 --restart 0.8 --seeds 0
python graphcontrol.py --dataset Chameleon --epochs 100 --lr 0.5 --optimizer adamw --weight_decay 5e-4 --threshold 0.17 --walk_steps 256 --restart 0.8 --seeds 0
**GCC with GraphControl**
CUDA_VISIBLE_DEVICES=1 python graphcontrol.py --dataset Chameleon --epochs 100 --lr 0.5 --optimizer adamw --weight_decay 5e-4 --threshold 0.17 --walk_steps 256 --restart 0.8 --seeds 0 1 2 3 4
...
CUDA_VISIBLE_DEVICES=0 python graphcontrol.py --dataset Chameleon --few_shot 10 --epochs 200 --lr 0.1 --optimizer adamw --weight_decay 5e-4 --threshold 0.17 --walk_steps 256 --restart 0.8 --seeds 0 1 2 3 4

CUDA_VISIBLE_DEVICES=1 python graphcontrol.py --dataset Chameleon --few_shot 5 --epochs 200 --lr 0.1 --optimizer adamw --weight_decay 5e-4 --threshold 0.17 --walk_steps 256 --restart 0.8 --seeds 0 1 2 3 4
